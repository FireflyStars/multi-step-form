<template>
  <div class="slider">
    ...
    <div class="slider_tracker_values w-100 d-flex">
        <div class="w-50 text-gray">{{ sliderMin }}</div>
        <div class="w-50  text-gray text-right">{{ sliderMax }}</div>
    </div>
  </div>
</template>
...
<style scoped>
    @import '../assets/css/custom-range-slider.css';
</style>